...
async function schedulingTab(browser, newUserCredentials) {
  ...
  browser.expect.element(`[data-test-id='GeneralVisitOption']`).to.be.present;
  browser.click(`[data-test-id='GeneralVisitOption']`)
  ...
  browser.expect.element(`[data-test-id='rowClick9']`).to.be.present;
  //click nick
  browser.click(`[data-test-id='rowClick9']`)
  //expect date field
  ...
  //click a date
  browser.pause(2000)
  browser.expect.element(`[data-test-id='calendarDay1']`).to.be.present;
  browser.click(`[data-test-id='calendarDay1']`)
  //click time field
  browser.expect.element(`[data-test-id='editAppointmentTime']`).to.be.present;
  browser.click(`[data-test-id='editAppointmentTime']`)
  browser.pause(2000)
  //set time
  browser.expect.element(`[data-test-id='timeSlot7:00 AM']`).to.be.present;
  browser.click(`[data-test-id='timeSlot7:00 AM']`)
  ...
  browser.pause(5000)
  browser.expect.element(`[data-test-id='nextThirtyDays']`).to.be.present;

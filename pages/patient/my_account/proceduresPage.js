const elements = {
    ...
    //Input textfield caption : "Please list any known procedures"
...
const commands = [{
    ...
    */
    accessProceduresPage(email, password){
        this
        ...
        this
            .waitForElementVisible('@proceduresSection')
            .pause(1000)
            .click('@proceduresSection')
    ...
    */
   openSectionfromMenu(){
    return this.waitForElementVisible('@proceduresSection')
    .click('@proceduresSection')
    .waitForElementVisible('@btnEdit')
    },
    ...
    */
    cleanList() {
        return this.api.elements('@itemListSaved', result => {
            ...
            this.expect.element('@list').text.to.contain('No known procedures')
        });
    },
    ...
    */
    ...
    /*
    *    This function adds custom entry with text "Procedures - Automation"
    */
    addCustomEntry() {
        var newCustomText = "Procedures - Automation"
        return this.click(`@btnEdit`)
            .waitForElementVisible(`@btnToggle`)
